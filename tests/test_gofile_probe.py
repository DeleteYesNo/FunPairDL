...
FOLDER = {
    "status": "ok",
    "data": {
        "id": "0badf00d", "type": "folder",
        "name": "a folder",
        "children": {
            "k1": {"id": "k1", "type": "file", "name": "video.mp4", "size": 669000000},
            "k2": {"id": "k2", "type": "file", "name": "script.funscript", "size": 150000},
...
def test_folder_link_sums_only_its_files():
    ...
    assert info["size"] == 669000000 + 150000
