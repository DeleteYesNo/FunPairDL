...
// ("[External] …") are not filenames and must stay out of the map.
{
  ...
  const parsed = {
    ...
    videos: [],
    scripts: [
      { url: "https://cdn.example/4a886e3b.funscript", filename: "Work A_regular.funscript", author: "Clothed" },
  ...
  check("send carries the forum script's real filename",
    g && g.filenames["https://cdn.example/4a886e3b.funscript"], "Work A_regular.funscript");
  check("send keeps the author map alongside",
    g && g.script_authors["https://cdn.example/4a886e3b.funscript"], "Clothed");
